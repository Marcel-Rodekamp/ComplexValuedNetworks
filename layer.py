...
class AffineCoupling(torch.nn.Module):
    ...
    def forward(self, xA, xB):
        ...
        return mout.exp()*xA+aout, mout.detach().sum(dim=-1)
...
class PRCL(torch.nn.Module):
    ...
    """
    def __init__(self, V, coupling1, coupling2):
        r"""
        ...
        self.mask = torch.ones(V, dtype=torch.bool, requires_grad=False)
        ...
        self.mask[:] = self.mask[torch.randperm(V)]
