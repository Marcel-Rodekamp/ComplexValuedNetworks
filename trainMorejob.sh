...
#SBATCH --job-name="Grid Search Nt = 16 train more"
#SBATCH --output=./out.%j
#SBATCH --error=./err.%j
...
srun python -u /p/home/jusers/dinca1/jureca/ComplexValuedNetworks/ModularCode/BigHopes/trying/TrainMore/app_trainMoreEquiv.py
